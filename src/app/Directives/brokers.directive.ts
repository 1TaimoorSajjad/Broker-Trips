...
export class BrokersDirective implements OnInit {
  ...
  onClick() {
    ...
    const brokerListComponentFactory =
      this.componentFactoryResolver.resolveComponentFactory(
        BrokerlistComponent
      );
    const brokerListComponentRef = this.viewContainerRef.createComponent(
      brokerListComponentFactory
    );
    brokerListComponentRef.instance.blist = this.forform;
    brokerListComponentRef.instance.selectbrokerData.subscribe(
      (sbroker: any) => {
